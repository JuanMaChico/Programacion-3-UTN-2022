...
class Auto
{
    ...
    public function __construct($marca, $color, $precio = 0, $fecha = "")
    {
        ...
        $this->_color = $color;
        $this->_precio = $precio;
        $this->_fecha = $fecha ? $fecha : date("Y-m-d");
    }

    public function AgregarImpuestos($param)
    {
        $this->_precio += $param;
    }
    ...
    {
        return "<br> Marca: ". $auto->_marca."<br> Color: ". $auto->_color ."<br> Precio: ". $auto->_precio ."<br> Fecha: " . $auto->_fecha;
    }
