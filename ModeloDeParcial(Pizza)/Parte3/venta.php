...
class Venta{
    ...
    public function ModificarVenta(){
        ...
        $heladoRequerido = new Helado("", $this->_sabor, "", $this->_tipo, "");
        if ($ventaEnBd && $heladoRequerido->RetornarHeladoIgual(Helado::ObtenerHelados("heladeria.json"))!= null){//si existe la venta y la pizza
