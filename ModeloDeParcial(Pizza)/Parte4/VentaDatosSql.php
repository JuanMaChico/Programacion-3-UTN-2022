...
class VentaDatosSql
{
	...
	public static function BorrarVentaEnTablaPorNumPedido($numPedido){
		$objetoAccesoDato = AccesoDatosSql::ObtenerObjectoAccesoDatos(); 
		 $consulta =$objetoAccesoDato->RetornarConsulta("DELETE FROM ventas WHERE num_pedido = :numpedido");
		 $consulta->bindValue(':numpedido', $numPedido, PDO::PARAM_INT);
